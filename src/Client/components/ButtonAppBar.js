...
export default function ButtonAppBar() {
  ...
  const list = (left) => (
    ...
    >
      ...
      >
        <ListItemButton onClick={()=>goNavigate("/client/home")}>
          <ListItemIcon>
        ...
        <Collapse in={open} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            <ListItemButton sx={{ pl: 4 }} onClick={()=>goNavigate("/client/day")}>
              <ListItemIcon>
                <CalendarTodayIcon style={{ color: "white" }}/>
              </ListItemIcon>
              <ListItemText primary="Diarios" />
            </ListItemButton>
            <ListItemButton sx={{ pl: 4 }} onClick={()=>goNavigate("/client/month")}>
              <ListItemIcon>
                <DateRangeIcon style={{ color: "white" }}/>
              </ListItemIcon>
              <ListItemText primary="Mensuales" />
            </ListItemButton>
            <ListItemButton sx={{ pl: 4 }} onClick={()=>goNavigate("/client/anual")}>
              <ListItemIcon>
                <EventNoteIcon style={{ color: "white" }}/>
              </ListItemIcon>
              <ListItemText primary="Anuales" />
            </ListItemButton>
          </List>
        </Collapse>
        <ListItemButton onClick={()=>goNavigate("/client/ecoquivalencia")}>
          <ListItemIcon>
            <NaturePeopleIcon style={{ color: "white" }}/>
          </ListItemIcon>
          <ListItemText primary="Ecoquivalencia Mensual" />
        </ListItemButton>
        <ListItemButton onClick={()=>goNavigate("/client/home")}>
          <ListItemIcon>
